...
def generate_response(text):
            ...
            try:
                response = "https://a.picoapps.xyz/ask-ai?prompt=${encodeURIComponent('You are a Callbot, re-generate this introduction message in a welcoming very short way and be creative and welcoming : "  + text + "')}"
...
async def main():
    ...
    try:
        ...
        text_to_speech(callbot.welcome)
